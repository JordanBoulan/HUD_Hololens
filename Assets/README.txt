...
1) Make a new scene and Add a player control object of your choice (e.g. Standard Asset -> First Person Controller)
...
-DemoMonsterScript, DemoMarkerSpawnerScript, and DemoQuestMarkerScript are for demo and code reference only, and are not critical for this package.
